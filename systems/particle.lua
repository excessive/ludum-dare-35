...
local particle = tiny.system {
	filter = tiny.requireAll("particles", "spawn_rate", "lifetime", "radius", "position"),
	layout = {
...
function particle:draw_particles(entity, shader)
	...
	if entity.disable_depth_test then
